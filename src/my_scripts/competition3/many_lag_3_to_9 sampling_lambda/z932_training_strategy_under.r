...
PARAM  <- list()
PARAM$experimento <- "TS9310_lag6_39_under"

PARAM$exp_input  <- "FE9250_lag6_39"
#_lag6_39_under
...
PARAM$train$undersampling_mayoritaria  <- 0.35   # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA

#Atencion, las semillas deben ser distintas
PARAM$train$semilla_sampling  <- 864379
PARAM$train$semilla_under     <- 300647
