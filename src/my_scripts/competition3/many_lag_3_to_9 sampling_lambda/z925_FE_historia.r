...
PARAM  <- list()
PARAM$experimento <- "FE9250_lag6_39"
...
{
  #creo los campos lags de orden 2
  dataset[ , paste0( cols_lagueables, "_lag4") := shift(.SD, 2, NA, "lag"), 
             by= numero_de_cliente, 
             .SDcols= cols_lagueables ]
...
{
  #creo los campos lags de orden 2
  dataset[ , paste0( cols_lagueables, "_lag5") := shift(.SD, 2, NA, "lag"), 
             by= numero_de_cliente, 
             .SDcols= cols_lagueables ]
...
{
  #creo los campos lags de orden 2
  dataset[ , paste0( cols_lagueables, "_lag6") := shift(.SD, 2, NA, "lag"), 
             by= numero_de_cliente, 
             .SDcols= cols_lagueables ]
