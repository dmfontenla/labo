...
PARAM  <- list()
PARAM$experimento <- "TS9310_c3test"

PARAM$exp_input  <- "FE9250_c3test"

PARAM$future       <- c( 202107 )

PARAM$final_train  <- c( 201909,201910,201911,201912,202001,202007,202008,202009,202010,202011,202012, 202101, 202102, 202103, 202104, 202105 )

PARAM$train$training     <- c( 201909,201910,201911,201912,202001,202007,202008,202009,202010,202011,202012, 202101, 202102, 202103 )
