...
PARAM  <- list()
PARAM$experimento <- "TS9320_4_BMDART"

PARAM$exp_input  <- "FE9250_4_BMDART"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201908, 201909, 201910, 201911, 201912, 202001, 202009,202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105, 202106, 202107 )

PARAM$train$training     <- c( 201908, 201909, 201910, 201911, 201912, 202001, 202009,202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105 )
...
PARAM$train$semilla_sampling  <- 864379
PARAM$train$semilla_under     <- 892237 # poner otra semilla
