...
PARAM  <- list()
PARAM$experimento <- "TS9310_4_OLM"

PARAM$exp_input  <- "FE9250_4_OLM"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201908, 201909, 202008, 202009, 202105, 202106, 202107 )

PARAM$train$training     <- c( 201908, 201909, 202008, 202009, 202104, 202105 )
